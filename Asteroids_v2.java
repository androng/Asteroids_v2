...
public class Asteroids_v2 extends Applet implements KeyListener, Runnable, FocusListener, ActionListener, MouseInputListener{
	...
	public void init(){
		...
		options.put("Friction", new Option("Enable friction breaks", true, "Patented FrictionBreak� technology makes you slow down over time even though there is nothing around you! It makes it easier to steer the ship."));
